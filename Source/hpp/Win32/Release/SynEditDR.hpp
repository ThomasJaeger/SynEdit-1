...
// (DO NOT EDIT: machine generated header) 'SynEditDR.pas' rev: 25.00 (Windows)
...
#include <SynEditWordWrap.hpp>	// Pascal unit
...
#include <SynEditPrintMarginsDialog.hpp>	// Pascal unit
...
#include <SynUsp10.hpp>	// Pascal unit
